...
idx_learn_all = dlmread('wine_idx_learn.csv');
idx_test_all = dlmread('wine_idx_test.csv');
...
% end
% dlmwrite('wine_indices_kmeans.csv', indices);
indices = dlmread('wine_indices_kmeans.csv');
