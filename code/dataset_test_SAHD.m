...
% dlmwrite('SAHD_idx_learn.csv', idx_learn_all);
% dlmwrite('SAHD_idx_test.csv', idx_test_all);
idx_learn_all = dlmread('SAHD_idx_learn.csv');
idx_test_all = dlmread('SAHD_idx_test.csv');
...
% end
% dlmwrite('SAHD_indices_kmeans.csv', indices);
indices = dlmread('SAHD_indices_kmeans.csv');
