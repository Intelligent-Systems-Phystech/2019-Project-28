...
% dlmwrite('yeast_idx_learn.csv', idx_learn_all);
% dlmwrite('yeast_idx_test.csv', idx_test_all);
idx_learn_all = dlmread('yeast_idx_learn.csv');
idx_test_all = dlmread('yeast_idx_test.csv');
...
% end
% dlmwrite('yeast_indices_kmeans.csv', indices);
indices = dlmread('yeast_indices_kmeans.csv');
