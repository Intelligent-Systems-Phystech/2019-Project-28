...
% dlmwrite('german_idx_learn.csv', idx_learn_all);
% dlmwrite('german_idx_test.csv', idx_test_all);
idx_learn_all = dlmread('german_idx_learn.csv');
idx_test_all = dlmread('german_idx_test.csv');
...
% end
% dlmwrite('german_indices_kmeans.csv', indices);

indices = dlmread('german_indices_kmeans.csv');
